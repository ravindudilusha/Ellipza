              ...
              {[
                ...
                >
                  <motion.div
                    ...
                    className="w-14 h-14 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center group-hover:bg-white/30 transition-colors shadow-lg"
                  >
                    <item.icon size={24} />
                  </motion.div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 rounded-xl border border-gray-200 focus:border-purple-600 focus:ring-2 focus:ring-purple-200 outline-none transition-all bg-gray-50 focus:bg-white"
                    required
                  />
                </motion.div>
                ...
                >
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-6 py-4 rounded-xl border border-gray-200 focus:border-purple-600 focus:ring-2 focus:ring-purple-200 outline-none transition-all resize-none bg-gray-50 focus:bg-white"
                    required
                  />
                </motion.div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="relative w-full bg-gradient-to-r from-purple-600 via-violet-600 to-fuchsia-600 text-white py-5 rounded-xl overflow-hidden flex items-center justify-center gap-3 shadow-2xl shadow-purple-500/50 group"
                >
