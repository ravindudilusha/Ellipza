        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative group">
              ...
              {/* Glow Effect */}
              <motion.div
                className="absolute inset-0 rounded-3xl bg-gradient-to-br from-purple-400 to-violet-400 opacity-0 group-hover:opacity-20 blur-2xl transition-opacity -z-10"
              />
              ...
              <motion.div
                ...
                className="absolute bottom-8 left-1/2 transform -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-10 w-[90%] max-w-lg border border-purple-100/50"
              >
              <h3 className="text-center text-2xl text-gray-900 mb-8">
                Our <span className="bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent">Achievement Gallery</span>
              </h3>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  ...
                  >
                    <div className="text-5xl bg-gradient-to-r from-purple-600 to-fuchsia-600 bg-clip-text text-transparent mb-2">
          ...
          >
            <motion.div
              ...
              className="inline-block px-4 py-2 rounded-full bg-purple-100 text-purple-600 mb-6"
            >
              Our Impact
            </motion.div>
