...
export function About() {
  ...
  return (
    <section id="about" className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-white via-purple-50/30 to-violet-50/30">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative group">
              ...
              {/* Glow Effect */}
              <motion.div
                className="absolute inset-0 rounded-3xl bg-gradient-to-br from-purple-400 to-fuchsia-400 opacity-0 group-hover:opacity-20 blur-2xl transition-opacity -z-10"
              />
